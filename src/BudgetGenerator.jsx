  ...
  return (
    <div style={{ background: "#14171A", minHeight: "100%", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main style={{ padding: "18px 16px 160px", maxWidth: 640, margin: "0 auto" }}>
        {/* Datos del cliente */}
        <section style={{ background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 10, padding: 14, marginBottom: 14 }}>
        ...
        <section style={{ marginBottom: 14 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {catalog.map((item) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid #2A2E33", background: "#1C2126", cursor: "pointer", fontSize: 12.5,
                }}
              >
            ...
            <button
              ...
              style={{
                display: "flex", alignItems: "center", gap: 6, padding: "8px 12px", borderRadius: 8,
                border: "1px dashed #3A3F45", background: "transparent", cursor: "pointer", fontSize: 12.5, color: "#6B7076",
              }}
            >
        ...
        <section style={{ marginBottom: 14 }}>
          ...
          {lineItems.length === 0 ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {lineItems.map((item) => (
                <div key={item.id} style={{ background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 8, padding: 10 }}>
        ...
        {lineItems.length > 0 && (
          <section style={{ background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 10, padding: 14, marginBottom: 14 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
              ...
              <span className="fm-mono" style={{ fontSize: 13, color: "#9CA1A7" }}>{marginPercent}%</span>
            </div>
            <input
      ...
      {lineItems.length > 0 && (
        <div style={{ position: "fixed", bottom: 60, left: 0, right: 0, background: "#1C2126", borderTop: "1px solid #2A2E33", padding: "10px 16px", display: "flex", gap: 10, maxWidth: 640, margin: "0 auto", zIndex: 9 }}>
          <button
            className="fm-btn" onClick={handleDownload}
            style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "12px 0", borderRadius: 8, border: "1px solid #1A1D21", background: "#1C2126", color: "#1A1D21", fontSize: 13.5, fontWeight: 600, cursor: "pointer" }}
          >
...
function TotalRow({ label, value, muted, big }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: big ? "2px 0" : "3px 0" }}>
      ...
      <span className={`fm-mono ${big ? "fm-display" : ""}`} style={{ color: big ? "#F5A623" : "#2A2E33", fontSize: big ? 19 : 13, fontWeight: big ? 700 : 500 }}>
        S/ {value.toFixed(2)}
      </span>
    </div>
  );
...
function ConfigPanel({ catalog, onSave, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(26,29,33,0.55)", display: "flex", alignItems: "flex-end", justifyContent: "center", zIndex: 50 }}>
      <div style={{ background: "#14171A", width: "100%", maxWidth: 640, maxHeight: "85vh", overflowY: "auto", borderRadius: "16px 16px 0 0", padding: 18 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 }}>
          {draft.map((item) => (
            <div key={item.id} style={{ display: "flex", gap: 6, alignItems: "center", background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 8, padding: 8 }}>
              <input
        ...
        <button
          ...
          style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 12px", borderRadius: 8, border: "1px dashed #3A3F45", background: "transparent", cursor: "pointer", fontSize: 12.5, color: "#6B7076", marginBottom: 18 }}
        >

  ...
  return (
    <div style={{ padding: 20, maxWidth: 640, margin: "0 auto" }}>
      ...
      {loading ? (
        ...
        <p style={{ color: "#4B5157", fontSize: 13.5 }}>Todavía no hay proveedores cargados.</p>
      ) : (
          ...
          {suppliers.map((s) => (
            <div key={s.id} style={row}>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {s.address && <div style={{ fontSize: 12.5, color: "#4B5157" }}>{s.address}</div>}
...
function Field({ label, children, style }) {
  return (
    <label style={{ display: "block", marginBottom: 10, fontSize: 12.5, color: "#4B5157", ...style }}>
      {label}

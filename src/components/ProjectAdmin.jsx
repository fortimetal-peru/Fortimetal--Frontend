  ...
  return (
    <div style={{ padding: 20, maxWidth: 640, margin: "0 auto" }}>
      ...
      {loading ? (
        ...
        <p style={{ color: "#4B5157", fontSize: 13.5 }}>Todavía no hay proyectos.</p>
      ) : (
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 50, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
      <div onClick={(e) => e.stopPropagation()} style={{ background: "#EDEEEC", width: "100%", maxWidth: 640, maxHeight: "88vh", overflowY: "auto", borderRadius: "16px 16px 0 0", padding: 18 }}>
        ...
        {tab === "gallery" && (
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {detail?.images?.map((img) => (
              <img key={img.id} src={`${MEDIA_BASE}${img.image_url}`} alt="" style={{ width: 84, height: 84, objectFit: "cover", borderRadius: 8, border: "1px solid #D8D9D6" }} />
            ))}
        ...
        {tab === "notifications" && (
          <div>
            <form onSubmit={handlePostNotification} style={{ background: "#fff", border: "1px solid #E5E6E3", borderRadius: 10, padding: 12, marginBottom: 12 }}>
...
const row = { display: "flex", alignItems: "center", gap: 6, background: "#fff", border: "1px solid #E5E6E3", borderRadius: 10, padding: "10px 12px" };
...
const addPhotoBtn = { width: 84, height: 84, borderRadius: 8, border: "1px dashed #D8D9D6", background: "#FAFAF9", display: "flex", alignItems: "center", justifyContent: "center", color: "#9CA1A7", cursor: "pointer" };

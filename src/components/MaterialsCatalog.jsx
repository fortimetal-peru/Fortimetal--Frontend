  ...
  if (submitted) {
    return (
      <div style={{ padding: 40, textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: 17, color: "#1A1A1A", marginBottom: 6 }}>¡Pedido enviado!</h2>
        <p style={{ color: "#4B5157", fontSize: 13.5 }}>Te contactaremos para confirmar disponibilidad y precio.</p>
  ...
  return (
    <div style={{ padding: 20, maxWidth: 640, margin: "0 auto", paddingBottom: 90 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
        <h1 className="fm-display" style={{ fontSize: 22, color: "#1A1A1A", display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <p style={{ color: "#4B5157", fontSize: 13.5, marginBottom: 16 }}>Arma tu pedido y lo confirmamos contigo.</p>
      ...
      {loading ? (
        ...
        <p style={{ color: "#4B5157", fontSize: 13.5 }}>Todavía no hay materiales publicados.</p>
      ) : (
          ...
          {materials.map((m) => (
            <div key={m.id} style={row}>
              {m.image_url ? (
                ...
                <div style={{ width: 48, height: 48, borderRadius: 8, background: "#EDEEEC", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      ...
      {showCart && (
        <div onClick={() => setShowCart(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 50, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#fff", width: "100%", maxWidth: 480, borderRadius: "16px 16px 0 0", padding: 18, maxHeight: "80vh", overflowY: "auto" }}>
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Comentario (opcional, ej. para cuándo lo necesitas)" style={{ width: "100%", padding: 10, fontSize: 13.5, border: "1px solid #D8D9D6", borderRadius: 8, minHeight: 56, resize: "vertical", boxSizing: "border-box", fontFamily: "inherit", marginBottom: 12 }} />
...
const stepBtn = { width: 26, height: 26, borderRadius: "50%", border: "1px solid #D8D9D6", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", padding: 0 };

  ...
  return (
    <div style={{ background: "#EDEEEC", minHeight: "100%", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 18, maxWidth: 520, margin: "0 auto" }}>
        {/* Paso 1: foto */}
        <section className="fm-card" style={{ background: "#FFFFFF", padding: 18, border: "1px solid #D5D7D4" }}>
          ...
          {!photo ? (
            <label
              ...
              style={{
                ...
                cursor: "pointer", color: "#4B5157", fontSize: 13.5,
              }}
            >
              <Camera size={18} />
            ...
            {COLORS.map((c) => (
              <button
                ...
                style={{
                  ...
                  border: color === c.id ? "3px solid #F5A623" : "1px solid #D5D7D4",
                }}
              />
            ))}
          </div>
        ...
        <button
          ...
          style={{
            display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
            background: !photo || isBusy ? "#D5D7D4" : "#F5A623",
          ...
          <section className="fm-card" style={{ background: "#FFFFFF", padding: 18, border: "1px solid #D5D7D4" }}>
            ...
            <button
              ...
              style={{
                ...
                padding: "8px 12px", fontSize: 13, color: "#4B5157", cursor: "pointer",
              }}
            >
        ...
        {options.map((opt) => (
          <button
            ...
            style={{
              ...
              border: value === opt.id ? "1px solid #F5A623" : "1px solid #D5D7D4",
...
function ErrorBanner({ icon, title, message, onRetry }) {
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <p className="fm-display" style={{ fontSize: 13.5, color: "#1A1A1A", margin: 0 }}>{title}</p>
        <p style={{ fontSize: 12.5, color: "#4B5157", margin: "4px 0 8px" }}>{message}</p>
        <button
          onClick={onRetry}
          style={{

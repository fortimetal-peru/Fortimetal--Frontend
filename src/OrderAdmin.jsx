  ...
  return (
    <div style={{ padding: 20, maxWidth: 640, margin: "0 auto" }}>
      ...
      {loading ? (
        ...
        <p style={{ color: "#9CA1A7", fontSize: 13.5 }}>Todavía no hay pedidos.</p>
      ) : (
            ...
            return (
              <div key={o.id} style={card}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, marginBottom: 8 }}>
                  <div>
                    <div style={{ fontWeight: 600, fontSize: 14, color: "#F4F4F3" }}>{client?.full_name || "Cliente"}</div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4, marginBottom: 8 }}>
                  {o.items.map((it) => (
                    <div key={it.id} style={{ display: "flex", justifyContent: "space-between", fontSize: 13, color: "#9CA1A7" }}>
...
const card = { background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 12, padding: 14 };
const selectStyle = {
  appearance: "none", padding: "6px 26px 6px 10px", fontSize: 12.5, border: "1px solid #2A2E33",
  borderRadius: 8, background: "#1C2126", fontFamily: "inherit", cursor: "pointer",
};

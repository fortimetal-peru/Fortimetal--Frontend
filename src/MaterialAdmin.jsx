  ...
  return (
    <div style={{ padding: 20, maxWidth: 640, margin: "0 auto" }}>
        ...
        <form onSubmit={handleSubmit} style={formCard}>
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6 }}>
              {form.image_url && (
                <img src={`${MEDIA_BASE}${form.image_url}`} alt="" style={{ width: 56, height: 56, objectFit: "cover", borderRadius: 8, border: "1px solid #2A2E33" }} />
              )}
      ...
      {loading ? (
        ...
        <p style={{ color: "#9CA1A7", fontSize: 13.5 }}>Todavía no hay materiales.</p>
      ) : (
          ...
          {materials.map((m) => (
            <div key={m.id} style={{ ...row, opacity: m.is_active ? 1 : 0.5 }}>
              {m.image_url ? (
                ...
                <div style={{ width: 44, height: 44, borderRadius: 8, background: "#14171A", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
...
function StockAdjustPanel({ material, accessToken, onClose, onSaved }) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 50, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
      <div onClick={(e) => e.stopPropagation()} style={{ background: "#1C2126", width: "100%", maxWidth: 480, borderRadius: "16px 16px 0 0", padding: 18 }}>
...
const row = { display: "flex", alignItems: "center", gap: 8, background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 10, padding: "10px 12px" };
...
const btnSecondary = { ...btnPrimary, background: "#1C2126", border: "1px solid #2A2E33", color: "#F4F4F3" };

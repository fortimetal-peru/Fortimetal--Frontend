  ...
  return (
    <div style={{ background: "#14171A", minHeight: "100%", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main style={{ padding: "18px 16px 100px", maxWidth: 640, margin: "0 auto" }}>
          ...
          {STRUCTURE_TYPES.map((t) => (
            <button
              ...
              style={{
                ...
                padding: "10px 6px",
                borderRadius: 8,
                border: structureType === t.id ? "1px solid #F5A623" : "1px solid #2A2E33",
        ...
        <section style={{ background: "#1C2126", border: "1px solid #2A2E33", borderRadius: 10, padding: 16, marginBottom: 16 }}>
                  ...
                  {[{ id: "dos_aguas", label: "Dos aguas" }, { id: "una_agua", label: "Una agua" }, { id: "parabolico", label: "Parabólico" }].map((opt) => (
                    <button
                      ...
                      style={{
                        ...
                        border: roofType === opt.id ? "1px solid #1A1D21" : "1px solid #2A2E33",
          ...
          <>
            ...
            <div style={{ background: "#1A1D21", borderRadius: 10, overflow: "hidden", marginBottom: 12 }}>
              {result.items.map((item, i) => (
                ...
                >
                  <span style={{ color: "#2A2E33", fontSize: 13.5 }}>{item.description}</span>
  ...
  return (
    <div style={{ flex: full ? "1 1 100%" : 1 }}>
      ...
      <input
        ...
        style={{
          width: "100%", border: "1px solid #2A2E33", borderRadius: 6, padding: "9px 10px",
          fontSize: 14, color: "#1A1D21", background: "#1C2126", boxSizing: "border-box",
        }}
      />
    </div>
  );
